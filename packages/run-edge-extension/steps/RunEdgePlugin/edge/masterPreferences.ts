...
// * Official Source code: https://src.chromium.org/viewvc/edge/trunk/src/edge/common/pref_names.cc?view=markup
...
const masterPreferences = {
  ...
  distribution: {
    ...
    // Boolean. Whether to instruct the installer to auto-launch edge on computer
    ...
    // Boolean. Do not launch Edge after first install. Cmd line override present.
    // "do_not_launch_chrome": true,

    // Boolean. Do not register with Google Update to have Edge launched after
    // install. Cmd line override present.
    do_not_register_for_update_launch: true,

    // Boolean. Register Edge as default browser. Cmd line override present.
    make_chrome_default: false,

    // Boolean. Register Edge as default browser for the current user.
