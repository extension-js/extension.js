...
import type {BrowserType, PluginInterface} from '../../browsers-types'
...
export class ChromiumSourceInspectionPlugin {
  private devOptions: Pick<
    PluginInterface,
    'port' | 'source' | 'watchSource'
  > & {
    startingUrl?: string
    instanceId?: string
    browser?: BrowserType
  ...
  constructor(
    devOptions: Pick<PluginInterface, 'port' | 'source' | 'watchSource'> & {
      startingUrl?: string
      instanceId?: string
    },
    _ctx?: unknown
