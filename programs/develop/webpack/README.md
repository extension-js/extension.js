...
A set of Rspack-powered plugins used by Extension.js to build browser extensions. Each plugin is small and focused; together they provide a developer experience with sensible defaults and production-ready output.
