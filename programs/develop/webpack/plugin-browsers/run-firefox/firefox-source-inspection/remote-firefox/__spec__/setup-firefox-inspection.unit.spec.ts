...
vi.mock('../remote-firefox/messaging-client', () => {
...
vi.mock('../remote-firefox/setup-firefox-inspection-actors', () => ({
  selectActors: vi.fn(async () => ({tabActor: 'tab', consoleActor: 'console'}))
}))

vi.mock('../remote-firefox/setup-firefox-inspection-navigation', () => ({
...
import {SetupFirefoxInspectionStep} from '../setup-firefox-inspection'
