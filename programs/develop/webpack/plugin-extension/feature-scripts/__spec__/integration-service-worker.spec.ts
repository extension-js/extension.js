...
describe('ScriptsPlugin service worker modes', () => {
  it(
    'builds classic background.service_worker (chunkLoading import-scripts behavior)',
    async () => {
  ...
  it(
    'builds module background service worker without importScripts specific code',
    async () => {
