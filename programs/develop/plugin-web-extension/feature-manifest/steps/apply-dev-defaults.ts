...
// and ships broken — the masking is invisible until production. `tabs`
        ...
        compilation.hooks.processAssets.tap(
          ...
          () => {
            ...
            const patchedManifest = {
              ...
              // storage is injected in BOTH eras (era-consistency): the
            ...
            // warn when the user's own source leans on a permission only
