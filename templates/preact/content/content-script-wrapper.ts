/**
 * Content Script Wrapper Module for Preact
 *
...
export class ContentScriptWrapper implements ContentScriptInstance {
  ...
  async mount(
    ...
    try {
      ...
      try {
        ...
        // Add fallback content if Preact rendering fails
        const errorMessage =
          error instanceof Error ? error.message : String(error)
        this.container!.innerHTML = `
          <div style="text-align: center;">
            <h3>Extension Content</h3>
            <p>Preact rendering failed, but the wrapper is working!</p>
  ...
  /**
   * Create the container element for the Preact app
   */
