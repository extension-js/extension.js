/**
 * Content Script Wrapper Module for Vue
 *
...
export class ContentScriptWrapper implements ContentScriptInstance {
  ...
  async mount(
    ...
    try {
      ...
      try {
        ...
        // Add fallback content if Vue rendering fails
        const errorMessage =
          error instanceof Error ? error.message : String(error)
        this.container!.innerHTML = `
          <div style="text-align: center;">
            <h3>Extension Content</h3>
            <p>Vue rendering failed, but the wrapper is working!</p>
  ...
  /**
   * Create the container element for the Vue app
   */
